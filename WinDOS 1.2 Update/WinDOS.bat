...
timeout 3 > NUL
echo Checking files... 
If exist "D:\Le Trieu Duong\Programming\WinDOS 1.2\SYS\BOOT.ini" (
    msg * Files existed...
) 
if NOT exist "D:\Le Trieu Duong\Programming\WinDOS 1.2\SYS\BOOT.ini" (
   msg * WinDOS has encoutered a problem. Please check your files or re-open WinDOS again.
   pause 
   exit 
)
:login
